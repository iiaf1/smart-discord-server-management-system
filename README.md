...
IAF is an integrated Discord platform designed for server management, proactive protection, permissions, and web-based control. It brings together a smart Discord bot, a real-time synchronization system, and a modern web dashboard into one unified system — giving server owners full visibility and control over their community.
...
- **Discord Bot** — handles all in-server actions, moderation, and automation.
- **Real-Time System** — the bridge that keeps data flowing instantly between the bot and the dashboard.
- **Web Dashboard** — the control center where admins manage permissions, view activity, and configure the system.
...
- Secure handling of store and payment data

---

## 🛠️ Tech Stack

- **Node.js** — runtime environment powering the entire platform
